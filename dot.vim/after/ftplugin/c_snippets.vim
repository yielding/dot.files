...
exec "Snippet do do<CR>{<CR>".st.et."<CR>}<CR> while (".st.et.");".st.et
exec "Snippet try try<CR>{<CR>".st.et."<CR>}<CR>catch (".st.et.")<CR>{<CR>".st.et"<CR>}<CR>".st.et
...
exec "Snippet ns namespace ".st.":substitute(expand('%'),'.','\\l&', 'g')".et."{<CR>".st.et."<CR>};<CR>".st.et
...
exec "Snippet main int main(int argc, char const* argv[])<CR>{<CR>".st.et."<CR><ESC>i<TAB>return 0;<CR>}<CR>".st.et
