...
"
nmap <silent> <unique> ,c <Plug>Commentifyj
"nmap <silent> <unique> ,x <Plug>Commentify
"
"nmap <silent> <unique> <M-c> <Plug>Commentifyj
"nmap <silent> <unique> <M-x> <Plug>Commentify

imap <silent> <unique> ,c <Esc><Plug>Commentifyji
"imap <silent> <unique> ,x <Esc><Plug>Commentifyi
"
"imap <silent> <unique> <M-c> <Esc><Plug>Commentifyji
"imap <silent> <unique> <M-x> <Esc><Plug>Commentifyi

vmap <silent> <unique> ,c <Plug>Commentify
"
